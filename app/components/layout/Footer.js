        ...
        <footer className="footer">
            <div className="container footer-container">
                ...
                <div className="footer-col">
                    ...
                    <h4>Contact</h4>
                    <p>
                        <a href="tel:7043169204" style={{ color: 'inherit', textDecoration: 'none' }}> 7043169204 (11 AM to 5 PM) </a>
                        <br />
                        <a href="mailto:khodiyaroilmill@outlook.com" style={{ color: 'inherit', textDecoration: 'none' }}>
